...
swap_script_address=$(${cli} address build --payment-script-file ${swap_script_path} --stake-script-file ${stake_path} --testnet-magic ${testnet_magic})
...
# ${cli} query utxo \
#     --address ${swap_script_address} \
#     --testnet-magic ${testnet_magic} \
#     --out-file ../tmp/script_utxo.json
# TXNS=$(jq length ../tmp/script_utxo.json)
# if [ "${TXNS}" -eq "0" ]; then
#    echo -e "\n \033[0;31m NO UTxOs Found At ${swap_script_address} \033[0m \n";
#    exit;
# fi
# alltxin=""
