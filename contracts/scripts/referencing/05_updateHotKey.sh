...
echo "Update Hotkey OUTPUT: "${script_address_out}
#
# exit
#
# get deleg utxo
...
pkh="41c5a3e9b01c41799d42d84fcda7b23abe5993dfd47f386513e07dfa"
alltxin=""
TXIN=$(jq -r --arg alltxin "" --arg delegPkh "${pkh}" 'to_entries[] | select(.value.inlineDatum.fields[0].fields[0].bytes == $delegPkh) | .key | . + $alltxin + " --tx-in"' ../tmp/script_utxo.json)
script_tx_in=${TXIN::-8}
