...
out_address_out="addr_test1qzunw0vg9n7phz392tkewl4x2kacsu2286qk790qvt4sdg6hu0s5mnhxh2853wtsgn9gdz6wuqtaqnkv0yk78p474d6qtffcpn + ${min_utxo} + ${asset}"
echo "Transform OUTPUT: "${seller_address_out}
#
# exit
#
