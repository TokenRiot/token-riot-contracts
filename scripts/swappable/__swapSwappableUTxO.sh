...
sc_address_out2="${script_address} + 15000000"
...
FEE=$(${cli} transaction build \
    ...
    --tx-in dae70a9a93e7c781a5b050a78c006eb3ba1c09bfd0ccb4fb4cb7e7a12bb23c07#1  \
    --spending-tx-in-reference="${script_ref_utxo}#1" \
    --spending-plutus-script-v2 \
    --spending-reference-tx-in-inline-datum-present \
    --spending-reference-tx-in-redeemer-file ../data/swap-redeemer.json \
    --tx-in dae70a9a93e7c781a5b050a78c006eb3ba1c09bfd0ccb4fb4cb7e7a12bb23c07#2  \
    --spending-tx-in-reference="${script_ref_utxo}#1" \
    --spending-plutus-script-v2 \
    --spending-reference-tx-in-inline-datum-present \
    --spending-reference-tx-in-redeemer-file ../data/swap-redeemer.json \
    --tx-out="${sc_address_out1}" \
    --tx-out-inline-datum-file ../data/flatrate-swappable-datum.json  \
    --tx-out="${sc_address_out2}" \
    --tx-out-inline-datum-file ../data/swappable-datum.json \
